...
void printUsage() {
  ...
  printf("             [-rp privkey partialkeyfile] [-sk startKeyHex] [-ek endKeyHex] [prefix]\n\n");
  ...
  printf(" -sk startKeyHex: Start search from specific private key in hex format\n");
  printf(" -ek endKeyHex: End search at specific private key in hex format (search stops when endKey is reached)\n");
...
int main(int argc, char* argv[]) {
  ...
  VanitySearch *v = new VanitySearch(secp, prefix, seed, searchMode, gpuEnable, stop, outputFile, sse,
    maxFound, rekey, caseSensitive, startPuKey, paranoiacSeed, startKeyHex, endKeyHex);
